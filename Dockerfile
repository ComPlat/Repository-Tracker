...
# postgresql14-dev includes C header files that are needed to build pg gem
# gcompat includes GNU C library compatibility layer needed for Nokogiri
RUN apk add --no-cache tzdata icu-data-full nodejs yarn build-base postgresql14-dev gcompat
WORKDIR /repository-tracker
